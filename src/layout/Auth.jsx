          ...
          <div className="mt-8">
            <div className="mt-6">
              <form action="#" method="POST" className="space-y-6">
                ...
                <div className="border border-green-600 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                  <label
                    htmlFor="name"
                  ...
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block w-full bg-transparent border-0 p-0 text-gray-900 placeholder-gray-100 focus:ring-0 sm:text-sm"
